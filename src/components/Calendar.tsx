...
export function PerformanceCalendar({ trades, sentiments }: CalendarProps) {
  ...
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-3xl font-bold tracking-tight text-white mb-2">Performance Calendar</h1>
        <p className="text-gray-400">Track your P&L and emotional state day by day.</p>
      </header>
      ...
      <div className="glass-panel p-6">
        ...
        <div className="grid grid-cols-7 gap-4">
          {paddingDays.map((_, i) => (
            <div key={"padding-" + i} className="h-28 rounded-xl bg-white/5 opacity-50" />
          ))}
              ...
              >
                ...
                {dayTrades.length > 0 && (
                  <div className="mt-auto flex flex-col items-end">
                    ...
                    <span className="text-xs text-gray-400">{dayTrades.length} trades</span>
                  </div>
                )}
              </div>
            );
